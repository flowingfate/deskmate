...
echo "🔍 DESKMATE App Sandbox Status Diagnosis"
echo "================================"

APP_PATH="/Applications/DESKMATE.app"
if [ ! -d "$APP_PATH" ]; then
...
if pgrep -f DESKMATE > /dev/null; then
    echo "✅ DESKMATE app is running"
    echo "Process ID: $(pgrep -f DESKMATE)"
else
    echo "❌ DESKMATE app is not running"
fi
echo ""
