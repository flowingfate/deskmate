...
const brandDir = path.resolve(__dirname, '..', 'brands', brandName);
const assetsMacDir = path.join(brandDir, 'assets', 'mac');
const assetsWinDir = path.join(brandDir, 'assets', 'win');
const iconMacPath = path.join(assetsMacDir, 'app.icns');
...
const winSource = path.join(assetsWinDir, 'icon_round_1024x1024.png');
const macSource = path.join(assetsMacDir, 'icon_round_1024x1024.png');
...
const macIconsDir = assetsMacDir;
const macIconsetDir = path.join(macIconsDir, 'app.iconset');
const macIconPath = iconMacPath;
