  ...
  describe('Windows dir command switch recognition', () => {
    test('should correctly identify paths and exclude the /b switch', () => {
      const paths = CommandParser.extractPathsFromCommand(
        'dir C:\\Users\\test\\AppData\\Local\\uv\\cache\\archive-v0\\xyz\\lib\\site-packages\\demo_mcp\\..\\..\\temp\\demo_query_results_*.csv /b'
      );

      expect(paths).toHaveLength(1);
      expect(paths[0]).toContain('demo_query_results_*.csv');
    ...
    test('should correctly handle nested cmd invocations', () => {
      ...
      const parameters = [
        'dir',
        'C:\\Users\\test\\AppData\\Local\\uv\\cache\\archive-v0\\xyz\\lib\\site-packages\\demo_mcp\\..\\..\\temp\\demo_query_results_*.csv',
        '/b',
        '/o:d'
      ];
