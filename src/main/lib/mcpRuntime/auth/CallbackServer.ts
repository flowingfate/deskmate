 ...
 */
export const DESKMATE_DEFAULT_OAUTH_CALLBACK_PORT = 33420;
...
class CallbackServer {
  ...
  async ensureRunning(preferredPort?: number): Promise<void> {
    const wantPort = preferredPort ?? DESKMATE_DEFAULT_OAUTH_CALLBACK_PORT;
...
export function getCallbackServer(port: number = DESKMATE_DEFAULT_OAUTH_CALLBACK_PORT): CallbackServer {
