...
export class DeskmateOAuthProvider implements OAuthClientProvider {
  ...
  async codeVerifier(): Promise<string> {
    if (!this._codeVerifier) {
      throw new Error(`[DeskmateOAuthProvider] No PKCE code verifier saved for ${this.serverName}`);
    }
