/**
 * Tests for DeskmateOAuthProvider — the SDK OAuthClientProvider implementation
...
vi.mock('../CallbackServer', () => ({
  ...
  DESKMATE_DEFAULT_OAUTH_CALLBACK_PORT: 33420,
}));

// In-memory backing for DeskmateTokenCache.mcpOAuth
...
describe('DeskmateOAuthProvider', () => {
