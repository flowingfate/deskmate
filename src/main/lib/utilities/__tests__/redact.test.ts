...
describe('createRedactor', () => {
  it('replaces profile id with <REDACTED_ALIAS>', () => {
    const redact = createRedactor({ profileId: 'alice' });
  ...
  it('works when profileId is null', () => {
    const redact = createRedactor({ profileId: null });
