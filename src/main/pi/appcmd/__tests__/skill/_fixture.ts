...
vi.mock('@main/pi/appcmd/builtins/skill/kernel/installSkill', () => ({
  installSkillInternal: skillMocks.installSkillInternal,
}));

vi.mock('@main/pi/appcmd/builtins/skill/kernel/uninstallSkill', () => ({
  uninstallSkillInternal: skillMocks.uninstallSkillInternal,
}));

vi.mock('@main/pi/appcmd/builtins/skill/kernel/bindSkill', () => ({
  bindSkillInternal: skillMocks.bindSkillInternal,
}));

vi.mock('@main/pi/appcmd/builtins/skill/kernel/unbindSkill', () => ({
  unbindSkillInternal: skillMocks.unbindSkillInternal,
}));

vi.mock('@main/pi/appcmd/builtins/skill/kernel/listSkills', () => ({
  listSkillsInternal: skillMocks.listSkillsInternal,
}));

vi.mock('@main/pi/appcmd/builtins/skill/kernel/getSkillStatus', () => ({
  getSkillStatusInternal: skillMocks.getSkillStatusInternal,
}));

vi.mock('@main/pi/appcmd/builtins/skill/kernel/searchLibrary', () => ({
...
import { skillCommand } from '@main/pi/appcmd/builtins/skill';
