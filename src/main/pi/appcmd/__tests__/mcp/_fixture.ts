...
vi.mock('@main/pi/appcmd/builtins/mcp/kernel/createServer', () => ({
  createServerInternal: mcpMocks.createServerInternal,
}));

vi.mock('@main/pi/appcmd/builtins/mcp/kernel/updateServer', () => ({
  updateServerInternal: mcpMocks.updateServerInternal,
}));

vi.mock('@main/pi/appcmd/builtins/mcp/kernel/getStatus', () => ({
...
import { mcpCommand } from '@main/pi/appcmd/builtins/mcp';
