...
vi.mock('@main/pi/appcmd/builtins/agent/kernel/createAgent', () => ({
  createAgentInternal: agentMocks.createAgentInternal,
}));

vi.mock('@main/pi/appcmd/builtins/agent/kernel/updateAgent', () => ({
  updateAgentInternal: agentMocks.updateAgentInternal,
}));

vi.mock('@main/pi/appcmd/builtins/agent/kernel/removeAgent', () => ({
  removeAgentInternal: agentMocks.removeAgentInternal,
}));

vi.mock('@main/pi/appcmd/builtins/agent/kernel/listAgents', () => ({
  listAgentsInternal: agentMocks.listAgentsInternal,
}));

vi.mock('@main/pi/appcmd/builtins/agent/kernel/getStatus', () => ({
  getStatusInternal: agentMocks.getStatusInternal,
}));

vi.mock('@main/pi/appcmd/builtins/agent/kernel/setPrimary', () => ({
...
import { agentCommand } from '@main/pi/appcmd/builtins/agent';
