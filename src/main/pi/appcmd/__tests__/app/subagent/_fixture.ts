...
vi.mock('@main/pi/appcmd/builtins/app/subagent/kernel/spawn', () => ({
  spawnSingleInternal: subagentMocks.spawnSingleInternal,
}));

vi.mock('@main/pi/appcmd/builtins/app/subagent/kernel/spawnMany', () => ({
...
import { subagentCommand } from '@main/pi/appcmd/builtins/app/subagent';
