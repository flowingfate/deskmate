...
vi.mock('@main/pi/appcmd/builtins/schedule/kernel/createJob', () => ({
  createJobInternal: scheduleMocks.createJobInternal,
}));

vi.mock('@main/pi/appcmd/builtins/schedule/kernel/listJobs', () => ({
  listJobsInternal: scheduleMocks.listJobsInternal,
}));

vi.mock('@main/pi/appcmd/builtins/schedule/kernel/updateJob', () => ({
  updateJobInternal: scheduleMocks.updateJobInternal,
}));

vi.mock('@main/pi/appcmd/builtins/schedule/kernel/deleteJob', () => ({
  deleteJobInternal: scheduleMocks.deleteJobInternal,
}));

vi.mock('@main/pi/appcmd/builtins/schedule/kernel/runJobNow', () => ({
...
import { scheduleCommand } from '@main/pi/appcmd/builtins/schedule';
