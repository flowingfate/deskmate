 ...
 * Renders avatar image when present; falls back to emoji.
 */
export const AgentAvatar: React.FC<AgentAvatarProps> = ({
  ...
  // Render image only when avatar is present and not errored.
  ...
  // No avatar URL or image failed to load — render emoji fallback
  return (
    <span data-dbg="agent-avatar-emoji" className={`inline-flex items-center justify-center shrink-0 ${getEmojiSizeStyles()} ${className}`}>
