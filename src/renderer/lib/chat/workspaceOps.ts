import { workspaceApi, workspaceEvents } from '@/ipc/workspace';
/**
...
export class WorkspaceOpsManager {
  ...
  async getWorkspaceFileTree(
    ...
    try {
      ...
      const result = await workspaceApi.getFileTree(
        workspacePath,
        options
      );
  ...
  async getDirectoryChildren(
    ...
    try {
      ...
      const result = await workspaceApi.getDirectoryChildren(
        dirPath,
        options
      );
      if (!result.success) {
  ...
  async clearFileTreeCache(workspacePath?: string): Promise<WorkspaceOperationResult> {
    try {
      ...
      const result = await workspaceApi.clearFileTreeCache(workspacePath);
  ...
  // ========== Advanced file watching feature ==========
  ...
  private setupEventListeners(): void {
    ...
    const removeFileChangedListener = workspaceEvents.fileChanged((_event, changes) => {
    ...
    const removeErrorListener = workspaceEvents.watchError((_event, error) => {
  ...
  async startWatch(
    ...
    try {
      ...
      const result = await workspaceApi.startWatch(
        workspacePath,
        options
      );
  ...
  async stopWatch(): Promise<WorkspaceOperationResult> {
    try {
      ...
      const result = await workspaceApi.stopWatch();
  ...
  async getWatcherStats(): Promise<WorkspaceOperationResult> {
    try {
      ...
      const result = await workspaceApi.getWatcherStats();
  ...
  async copyPathToWorkspace(
    ...
    try {
      ...
      const result = await workspaceApi.copyPath(
        sourcePath,
        destPath,
        options,
      );
  ...
  async copyPathsToWorkspace(
    ...
    try {
      ...
      const result = await workspaceApi.copyPaths(
        sourcePaths,
        destPath,
        options,
      );
  ...
  async openInSystemExplorer(path: string): Promise<WorkspaceOperationResult> {
    try {
      ...
      const result = await workspaceApi.showInFolder(path);
